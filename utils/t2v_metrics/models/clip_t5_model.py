...
class CLIPT5Model(VQAScoreModel):
    ...
    def load_model(self):
        ...
        self.hatie_processor = T.Compose([
            T.Resize((self.image_processor.crop_size['height'], self.image_processor.crop_size['width']),),
    ...
    def forward(self,
        ...
        images = torch.stack([self.hatie_processor(image) for image in images], dim=0).to(self.device)
